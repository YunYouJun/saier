...
export { default as PainterToolSwitcher } from './components/PainterToolSwitcher.vue'
export { default as PainterTransformBar } from './components/PainterTransformBar.vue'
