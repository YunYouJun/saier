...
const messages: Record<SiteLocale, SiteMessages> = {
  ...
  zh: {
    ...
    notices: {
      ...
      projectImportInvalidProject: '这个 JSON 不是有效的云绘工程。',
    ...
    cloudFiles: {
      ...
      empty: '暂无云端文件',
      finalizing: '正在确认上传...',
      invalidLibrary: '这个云端文件不是有效的云绘笔刷库。',
      invalidProject: '这个云端文件不是有效的云绘工程。',
      load: '载入',
      loading: '正在加载文件...',
      maxFileSize: '文件上限',
      memberPlan: '会员云空间',
